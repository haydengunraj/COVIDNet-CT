...
def parse_args(args):
    ...
    parser.add_argument('-mf', '--meta_file', type=str, required=True, help='Model meta file')
    parser.add_argument('-ck', '--ckpt', type=str, default=None, help='Checkpoint path')
    ...
    if args[0] == 'train':
        ...
        parser.add_argument('-tf', '--train_split_file', type=str,
                            default='COVIDx-CT_train.txt', help='Train split filename in data_dir')
        parser.add_argument('-vf', '--val_split_file', type=str,
                            default='COVIDx-CT_val.txt', help='Val split filename in data_dir')
